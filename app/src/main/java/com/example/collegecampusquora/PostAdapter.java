               ...
               // @SuppressLint("ResourceAsColor")
                ...
                public void onSuccess(DocumentSnapshot documentSnapshot) {
                    if(documentSnapshot != null) {
                        ...
                        if(upvoted != null) {
                            if(upvoted) {
                                upvoteButton.setColorFilter(R.color.clicked);
                                //upvoteButton.setBackgroundColor(R.color.clicked);
                            } else {
                                //downvoteButton.setBackgroundColor(R.color.clicked);
                                upvoteButton.setColorFilter(R.color.clicked);
                            }
                        }
                    }
...
//            queryUtils.setImage(context, postImage, item.getPostID());
            ...
            long upvotes = item.getUpvotes();
            long downvotes = item.getDownvotes();
